...
export const router = createBrowserRouter([
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'suppliers', element: <ComingSoonPage titleKey="nav.suppliers" /> },
      { path: 'stock', element: <ComingSoonPage titleKey="nav.stock" /> },
      { path: 'stock-opname', element: <ComingSoonPage titleKey="nav.stockOpname" /> },
      { path: 'stock-movement', element: <ComingSoonPage titleKey="nav.stockMovement" /> },
      { path: 'waste', element: <ComingSoonPage titleKey="nav.waste" /> },
      { path: 'purchase-orders', element: <ComingSoonPage titleKey="nav.purchaseOrders" /> },
      ...
      { path: 'recipe-cost', element: <ComingSoonPage titleKey="nav.recipeCost" /> },
      { path: 'low-stock-alerts', element: <ComingSoonPage titleKey="nav.lowStockAlerts" /> },
